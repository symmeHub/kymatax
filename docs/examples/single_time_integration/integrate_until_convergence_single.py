...
init_condition = jnp.array([0.0, 0.0, 0.0])

single_find = attractor_finder.find_attractors
problem, finder_configs, vmaped_init, solutions = single_find(
    problem,
    init_condition,
    finder_config,
)
...
#     solution_state_labels=["xa", "dotxa"],
# )
